...
class ChartPerRegionModel extends Model
{
    public function getChartPerRegion($area_name = false, $date_from = false, $date_to = false)
    {
        ...
        $builder = $builder->groupBy('area_name');
